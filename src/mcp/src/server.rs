...
impl MCPServer {
    ...
    async fn register_default_tools(&self) -> MCPResult<()> {
        use crate::tools::{detections::DetectionsTool, hosts::HostsTool, incidents::IncidentsTool, threat_intel::ThreatIntelTool};
    ...
    async fn initialize_resources(&self) -> MCPResult<()> {
        ...
        resources.push(Resource {
            ...
            description: "Comprehensive guide to FQL for searching detections and events".to_string(),
            mime_type: "text/markdown".to_string(),
