...
mod tests {
    ...
    async fn test_multiple_memory_protections() {
        ...
        manager.protect_region(0x1000, 0x1000, MemoryProtection::Read).await.unwrap();
        manager.protect_region(0x2000, 0x1000, MemoryProtection::Write).await.unwrap();
        manager.protect_region(0x3000, 0x1000, MemoryProtection::Execute).await.unwrap();
    ...
    async fn test_all_protection_types() {
        ...
        manager.protect_region(0x2000, 0x1000, MemoryProtection::Write).await.unwrap();
        manager.protect_region(0x3000, 0x1000, MemoryProtection::Execute).await.unwrap();
        manager.protect_region(0x4000, 0x1000, MemoryProtection::ReadWrite).await.unwrap();
        manager.protect_region(0x5000, 0x1000, MemoryProtection::ReadExecute).await.unwrap();
        manager.protect_region(0x6000, 0x1000, MemoryProtection::ReadWriteExecute).await.unwrap();
    ...
    async fn test_large_memory_region() {
        ...
        manager.protect_region(0x1000, 0x100000, MemoryProtection::ReadWrite).await.unwrap();
        assert_eq!(manager.protected_region_count().await, 1);
    }
    ...
    async fn test_zero_size_region() {
        ...
        manager.protect_region(0x1000, 0, MemoryProtection::Read).await.unwrap();
        assert_eq!(manager.protected_region_count().await, 1);
    }
}
